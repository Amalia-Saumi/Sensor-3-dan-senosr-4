...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    float debitAir3 = ((pulseCount3 / calibrationFactor) * 0.001);  // Debit dalam m³/menit
    float debitAir4 = ((pulseCount4 / calibrationFactor) * 0.001);  // Debit dalam m³/menit

    // Kirim data debit air ke Blynk
    Blynk.virtualWrite(V0, String(debitAir3, 3));  // Debit air sensor 3 (m³/menit)
    Blynk.virtualWrite(V1, String(debitAir4, 3));  // Debit air sensor 4 (m³/menit)
